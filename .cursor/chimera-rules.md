...
Before ANY code suggestion or file edit:
...
This prevents any premature implementation.
...
## State Block Templates (for Reporting Plans, Progress, Decisions)

Use one of these structured blocks whenever reporting status, proposing a plan, or making a decision. Copy-paste and fill in the placeholders.

### 1. Plan Proposal Block
